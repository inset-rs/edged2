...
- One panel window per screen at its right edge, slid in to a 28-point strip and sliding out to 250 points when the pointer reaches it, over a tenth of a second, easing as Edged does; as tall as its content and centred on the screen. While a full-screen window owns the screen the panel tucks to a hair inside the edge, invisible, and comes out when the pointer reaches the edge.
